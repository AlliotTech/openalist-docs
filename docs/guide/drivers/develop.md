...
Duplicate `drivers/template` to expand the new storage. Please read [CONTRIBUTING](https://github.com/AlliotTech/openalist/blob/main/CONTRIBUTING.md) for details.
