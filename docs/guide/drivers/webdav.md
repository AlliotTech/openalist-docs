...
For OneDrive/SharePoint, you can obtain the webdav root address through [this tool](https://tool.iots.vip/onedrive/webdav). If you want to mount the specified directory, you can join it later.
