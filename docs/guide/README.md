...
[![](https://img.shields.io/github/release/Xhofe/alist?style=flat-square)](https://github.com/AlliotTech/openalist/releases/latest)
...
- [x] [Alist](https://github.com/AlliotTech/openalist)
- [x] FTP
- [x] SFTP
...
Please go to our [discussion forum](https://github.com/AlliotTech/openalist/discussions) for general questions, **issues are for bug reports and feature request only.**
