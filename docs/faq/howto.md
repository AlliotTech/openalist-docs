...
An example of using nginx to reverse proxy to https://iots.vip/alist:
- Normal installation
- Set [site_url](../config/configuration.md#site_url) to `https://iots.vip/alist` or just `/alist` then restart alist
