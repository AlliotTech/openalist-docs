...
**安装**
```bash
curl -fsSL "https://alist.iots.vip/v3.sh" -o v3.sh && bash v3.sh
```
...
```bash
# Install
curl -fsSL "https://alist.iots.vip/v3.sh" -o v3.sh && bash v3.sh install /root
# update
curl -fsSL "https://alist.iots.vip/v3.sh" -o v3.sh && bash v3.sh update /root
# Uninstall
curl -fsSL "https://alist.iots.vip/v3.sh" -o v3.sh && bash v3.sh uninstall /root
```
