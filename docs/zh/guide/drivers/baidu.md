...
[点击这里](https://openapi.baidu.com/oauth/2.0/authorize?response_type=code&client_id=iYCeC9g08h5vuP9UqvPHKKSVrKFXGa1v&redirect_uri=https://alist.iots.vip/tool/baidu/callback&scope=basic,netdisk&qrcode=1) 来获取刷新令牌。
...
~~[**使用【本地代理 & Crack API】时候使用的UA**](https://github.com/AlliotTech/openalist/issues/5602#issuecomment-1831188682)~~ 非官方接口已无法使用
