...
- 如何配置PWA（Desktop、Android、IOS）：**[alist/issues/6724](https://github.com/AlliotTech/openalist/issues/6724#issuecomment-2220251541)**
...
可以自行前往查看：**https://github.com/AlliotTech/openalist/issues/3123**
